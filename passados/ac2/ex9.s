...
mensagem_fim: .string "pipiu"
str1: .string "isso é uma string"
str2: .space 20
...
main:
    li a0, 5
    la a1, vetor                    # Pseudo-instrução para carregar o endereço do vetor (no lugar das duas instruções anteriores)
    li a2, 10
...
MultiplicaVetor:    # Movimenta o apontador da pilha 4 posicoes para baixo (16 bytes) e guarda 4 registradores na pilha
    addi sp, sp, -16
